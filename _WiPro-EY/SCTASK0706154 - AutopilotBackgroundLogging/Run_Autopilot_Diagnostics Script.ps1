...
# - Creates the log folder if it does not already exist.
# - Creates the log file if it does not already exist.
# - Starts the transcript logging.
# - Invokes the main logic of the script.
# - Stops the transcript logging.
# - Exits the script with the exit code returned by the main logic.
# - Catches any unhandled exceptions and exits the script with a special exit code.
#       - Catches any unhandled exceptions and writes them to the console.
#       - Catches any unhandled exceptions and writes them to the log file.
#################################################################################
...
# - The exit code should be 0 if the script completed successfully.
# - The exit code should be 18181 if the script completed successfully but no changes were made.
# - The exit code should be 16161 if the script completed with an error.
#################################################################################

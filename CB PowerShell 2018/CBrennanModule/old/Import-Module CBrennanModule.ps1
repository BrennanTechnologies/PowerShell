...
function Import-CBrennanModule
{
    ...
    if( (Get-Module -Name "CBrennanModule")){write-host "The Custom Module is Loaded"     -ForegroundColor Green;exit}
    if(!(Get-Module -Name "CBrennanModule")){write-host "The Custom Module is NOT Loaded" -ForegroundColor Red;exit}
}

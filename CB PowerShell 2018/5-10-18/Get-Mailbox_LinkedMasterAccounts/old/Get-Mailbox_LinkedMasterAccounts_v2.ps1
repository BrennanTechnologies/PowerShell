...
function Get-Mailbox_LinkedMasterAccounts
{
    ...
    $ClientMailBoxes = Get-Mailbox -OrganizationalUnit $SearchOU -ResultSize unlimited | Where-Object {($_.LinkedMasterAccount -notlike "NT AUTHORITY*") -AND ($_.LinkedMasterAccount -notlike "ECICLOUD\Domain Controllers") -AND ($_ -notlike "S-1-*")} | Sort-Object -Property OrganizationalUnit

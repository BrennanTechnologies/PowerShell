...
function Export-Report-HTML1($ReportName, $ReportData)
{
    ############################
    # Export HTML Report
    ############################
    ...
    $ReportData | ConvertTo-HTML -Head $Header -PreContent $PreContent -PostContent $PostContent | Out-File $ReportFile
    start-process $ReportFile
}

function Email-Report($ReportName, $ReportData)
{
    ############################
    # Email Report
    ############################

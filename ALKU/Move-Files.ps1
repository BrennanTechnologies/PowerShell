<#
	https://code.pieces.app/plugins

	PS C:\Users\brenn> robocopy

	-------------------------------------------------------------------------------
	ROBOCOPY     ::     Robust File Copy for Windows
	-------------------------------------------------------------------------------

	Started : Thursday, August 10, 2023 4:54:22 AM
	...
	****  /MIR can DELETE files as well as copy them !
	...
	Started : Thursday, August 10, 2023 4:54:28 AM
...
function Copy-Files {
	...
	$Result = robocopy ....   # do the copy
	$Err = $Result -match 'ERROR'
	If ($err) {
		# Add the $ERR value to the mail - left as an exercise for the OP
	}
}
